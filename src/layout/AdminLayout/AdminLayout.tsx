  ...
  return (
    <>
      <Head>
        ...
        <link rel="icon" href="/assets/img/273198851_1788065084723794_5154145265366763313_n (1).jpg" />
        <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,200..800;1,200..800&display=swap" rel="stylesheet" />
      </Head>
      { noNetwork && (
        <div className="alert alert-danger mb-0 border-0 rounded-0 text-end p-2 bg-warning fw-bold position-fixed w-100 shadow-lg bottom-0 text-uppercase" role="alert">
          {noNetwork}
        </div>
      )}
